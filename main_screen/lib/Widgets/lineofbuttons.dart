...
class LineOfButtons extends StatefulWidget {
  ...
  GlobalKey<MapSampleState> mapKey;
  StreamController<MapType> mapStreamController = StreamController<MapType>();

  LineOfButtons(this.scaffoldKey, this.mapKey, this.mapStreamController);
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: FloatingActionButton(
            onPressed: widget.mapKey.currentState.goHome,
        ...
        Padding(
          padding: const EdgeInsets.all(5.0),
          child: FloatingActionButton(
            onPressed: widget.mapKey.currentState.setBearingView,
